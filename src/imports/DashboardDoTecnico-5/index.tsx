import svgPaths from "./svg-zoqm99lhbw";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="Container">
          <path d={svgPaths.p6c8ea80} fill="#8C4F00" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#2d1600] text-[14px] whitespace-nowrap">
          <p className="leading-[20px]">Novos documentos enviados pelo técnico após reprovação anterior.</p>
        </div>
      </div>
    </div>
  );
...
function AlertBanner() {
  return (
    <div className="bg-[#ffdcbf] relative rounded-[8px] shrink-0 w-full" data-name="Alert Banner">
      <div aria-hidden className="absolute border-[#8c4f00] border-l-4 border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Container22() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="Container">
          <path d={svgPaths.p3bae3440} fill="#DC2626" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Background2() {
  return (
    <div className="bg-[#fef2f2] content-stretch flex items-center justify-center relative rounded-[4px] shrink-0 size-[48px]" data-name="Background">
      <Container22 />
    </div>
  );
}
...
function DocItem() {
  return (
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full" data-name="Doc Item">
      <div aria-hidden className="absolute border-[#dc2626] border-l-4 border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
...
function Container35() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="Container">
          <path d={svgPaths.p1fe7b600} fill="#00356A" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Container35 />
        <div className="[word-break:break-word] flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#051d30] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Notas do juiz</p>
        </div>
      </div>
    </div>
  );
...
function Background4() {
  return (
    <div className="bg-[#cfe5ff] relative rounded-[4px] shrink-0 w-full" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[16px] pt-[24px] px-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Italic',sans-serif] font-normal italic justify-center leading-[0] relative shrink-0 text-[#34495e] text-[14px] whitespace-nowrap">
          <p className="leading-[20px]">“Por favor, corrija: o documento de direito de imagem está faltando a assinatura do responsável.”</p>
        </div>
      </div>
    </div>
  );
...
function NotesCommentsBentoItem() {
  return (
    <div className="bg-white col-[1/span_2] drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] justify-self-stretch relative rounded-[8px] row-1 self-start shrink-0" data-name="Notes/Comments Bento Item">
...
function BentoGridContent() {
  return (
    <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[_286px] relative shrink-0 w-full" data-name="Bento Grid Content">
      <NotesCommentsBentoItem />
    </div>
  );
}
...
function ProfileSummarySection() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[121px] relative shrink-0 w-full" data-name="Profile & Summary Section">
      <DocumentSection />
      <BentoGridContent />
    </div>
  );
...
function Container39() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-[15.833px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="17.5" preserveAspectRatio="none" viewBox="0 0 15.8333 17.5" width="15.8333">
        <g id="Container">
          <path d={svgPaths.p2d255e70} fill="#6B3B00" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container40() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#6b3b00] text-[12px] tracking-[-0.3px] uppercase w-[264px]">
        <p className="leading-[16px] whitespace-pre-wrap">{`AGUARDANDO   REAVALIAÇÃO`}</p>
      </div>
    </div>
  );
}
...
function Background5() {
  return (
    <div className="bg-[#ffdcbf] relative rounded-[8px] shrink-0 w-full" data-name="Background">
      <div className="flex flex-row items-center size-full">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.875px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#424751] text-[14px] w-full">
          <p className="leading-[22.75px] mb-0">Certifique-se de que todos os</p>
          <p className="leading-[22.75px] mb-0">documentos foram verificados</p>
          <p className="leading-[22.75px] mb-0">antes de proceder com a</p>
          <p className="leading-[22.75px]">aprovação.</p>
        </div>
      </div>
    </div>
  );
...
function Container43() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="Container">
          <path d={svgPaths.p1caa9380} fill="white" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#16a34a] content-stretch flex gap-[8px] items-center justify-center py-[16px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
      ...
      <Container43 />
      <div className="[word-break:break-word] flex flex-col font-['Space_Grotesk:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-center text-white tracking-[0.7px] uppercase whitespace-nowrap">
        <p className="leading-[20px]">APROVAR PARTICIPANTE</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white relative shrink-0 w-full" data-name="Background">
      <div className="flex flex-row justify-center size-full">
        <div className="content-stretch flex items-start justify-center px-[16px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#424751] text-[12px] text-center tracking-[1.2px] uppercase whitespace-nowrap">
...
function Label1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[236px]" data-name="Label">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#424751] text-[10px] tracking-[1px] uppercase whitespace-nowrap">
        <p className="leading-[15px]">MOTIVO DA REPROVAÇÃO</p>
      </div>
    </div>
  );
}
...
function Container48() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(114,119,130,0.5)] w-full whitespace-pre-wrap">
        <p className="leading-[20px] mb-0">{`Ex: CPF ilegível no documento `}</p>
        <p className="leading-[20px]">enviado...</p>
      </div>
    </div>
  );
}
...
function Textarea() {
  return (
    <div className="bg-[#edf4ff] h-[128px] relative rounded-[8px] shrink-0 w-full" data-name="Textarea">
...
function Container49() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
        <g id="Container">
          <path d={svgPaths.p28843fc0} fill="#BA1A1A" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] items-center justify-center px-px py-[17px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
      <div aria-hidden className="absolute border border-[#ba1a1a] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container49 />
      <div className="[word-break:break-word] flex flex-col font-['Space_Grotesk:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#ba1a1a] text-[14px] text-center tracking-[0.7px] uppercase whitespace-nowrap">
        <p className="leading-[20px]">REPROVAR INSCRIÇÃO</p>
      </div>
    </div>
  );
}
...
function HorizontalBorder1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start pt-[16.125px] relative shrink-0 w-full" data-name="HorizontalBorder">
      <div aria-hidden className="absolute border-[#e3efff] border-solid border-t inset-0 pointer-events-none" />
      <Container41 />
      <Container42 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#051d30] text-[12px] w-full">
        <p className="leading-[16px]">Upload de Correção</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#424751] text-[10px] w-full">
        <p className="leading-[15px]">Hoje, 14:20 • v2_docs.zip</p>
      </div>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[8px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#8c4f00] text-[12px] w-full">
        <p className="leading-[16px]">AGUARDANDO REAVALIAÇÃO</p>
      </div>
    </div>
  );
}
...
function TimelineItemCurrent() {
  return (
    <div className="relative shrink-0 w-full" data-name="Timeline Item: Current">
      <div className="content-stretch flex flex-col items-start pl-[32px] relative size-full">
        <Container51 />
        <div className="absolute bg-[#8c4f00] left-0 rounded-[12px] size-[24px] top-[4px]" data-name="Background+Border">
