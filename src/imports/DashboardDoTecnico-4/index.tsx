import svgPaths from "./svg-8q78ozywau";
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#6b3b00] text-[14px] whitespace-nowrap">
        <p className="leading-[20px]">Pendente de Revisão</p>
      </div>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pr-[4.92px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#424751] text-[10px] whitespace-nowrap">
          <p className="leading-[15px] mb-0">Última modificação pelo sistema em 12/03 às</p>
          <p className="leading-[15px]">14:20</p>
        </div>
      </div>
    </div>
  );
...
function ActivityFooter() {
  return (
    <div className="content-stretch flex gap-[12px] items-center pt-[25px] relative shrink-0 w-full" data-name="Activity Footer">
      <div aria-hidden className="absolute border-[#e3efff] border-solid border-t inset-0 pointer-events-none" />
      <div className="bg-[#22c55e] h-[8px] relative rounded-[12px] shrink-0 w-[7.22px]" data-name="Background" />
      <Container47 />
    </div>
  );
}
...
function LayoutGridBentoStyle() {
  return (
    <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[_803px] relative shrink-0 w-full" data-name="Layout Grid: Bento Style">
